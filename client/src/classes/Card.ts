	...
	constructor(type: Types, color: Colors, id: string) {
		...
		bg.beginFill(0x000000, 0.1)
			.drawRoundedRect(
				0,
				0,
				Card.WIDHT + Card.OUTLINE,
				Card.HEIGHT + Card.OUTLINE,
				5
			)
			.endFill();
		bg.beginFill(0xffffff)
			.drawRoundedRect(1, 1, Card.WIDHT, Card.HEIGHT, 5)
			.endFill();
		...
		if (type === 'none' && color === 'none') {
			...
			bg.drawRoundedRect(1, 1, Card.CORNER_W, Card.CORNER_H, 5)
				.drawRoundedRect(
					Card.WIDHT - (Card.CORNER_W - 1),
					1,
					Card.CORNER_W,
					Card.CORNER_H,
					5
